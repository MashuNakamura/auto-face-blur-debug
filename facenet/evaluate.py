#!/usr/bin/env python3
"""
FACENET - BATCH IMAGE EVALUATION (FINAL)
---------------------------------------------------
Evaluasi FaceNet + YOLO dari folder testing/ dengan subfolder:
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues',
            xticklabels=['Unknown','Me'], yticklabels=['Unknown','Me'])
