...
def get_embedding(img_bgr):
    ...
    # Resize to 160x160 (FaceNet standard)
...
while True:
    ...
    info = f"[{dev_str}] FaceNet | Infer: {inference_ms:.1f}ms | FPS: {fps:.1f}"

    cv2.rectangle(display, (0, 0), (640, 35), (0, 0, 0), -1)
    cv2.putText(display, info, (10, 25),
                cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 2)

    cv2.imshow("FaceNet - Realtime", display)
