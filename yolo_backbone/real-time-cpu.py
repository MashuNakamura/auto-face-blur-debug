#!/usr/bin/env python3
"""
YOLO BACKBONE - REALTIME WEBCAM TEST (CPU MODE ONLY)
---------------------------------------------------
...
while True:
    ...
    info_str = f"[CPU] YOLO-Backbone | FPS: {fps:.1f} (Avg: {avg_fps: .1f}) | Cache: {len(embedding_cache)}"
    ...
    cv2.imshow("YOLO Backbone - CPU Mode", display_frame)
...
# ============================================================
print("\n" + "=" * 60)
print("PERFORMANCE SUMMARY - YOLO BACKBONE CPU MODE")
print("=" * 60)
...
print("|---------------|--------|---------|-----------|------------|--------------------|")
print(
    f"| YOLO Backbone | CPU    | {avg_fps:.1f}    | {YOLO_SKIP_FRAMES:<9} | {EMBEDDING_SKIP_FRAMES:<10} | {cache_hit_rate:.1f}%               |")
print("\n")